...
namespace computrized_maintenance_Data_Access.Migrations
{
    ...
    [Migration("20251210202403_add_report_entity")]
    partial class add_report_entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("computrized_maintenance_Data_Access.Entites.preventiveMaintenanceManagement.PreventiveMaintenance", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Frequency = "Quarterly",
                            NextDueDate = new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            NextDueDate = new DateTime(2025, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("computrized_maintenance_Data_Access.Entites.WorkOrderManagement.WorkOrder", b =>
                {
                    ...
                    b.HasOne("computrized_maintenance_Data_Access.Entites.preventiveMaintenanceManagement.PreventiveMaintenance", "PreventiveMaintenance")
                        .WithMany("workOrders")
